    ...
    <div className="flex w-full min-h-[100vh] gap-5">
        ...
        <div className="flex flex-col items-center justify-start w-full gap-5 mt-[2rem]">
            ...
            <div className="flex flex-col w-full justify-center items-center">
                 <h1 className="text-xl mb-[2rem]">Usuń produkt</h1>
                <Input
                classNames={{
               ...
               {showResults  && searchText.trim() !== "" && (
                ...
                {selectedProduct && (
                    <div className="w-full mt-6 flex flex-col justify-center items-center gap-5">
                        <p>Zamierzasz usunąć następujący produkt: {selectedProduct.name}</p>
                        <Button onPress={()=>{deleteProduct(selectedProduct._id)}}>Usuń</Button>
                    </div>
                )}
            </div>
