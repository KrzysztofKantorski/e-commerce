...
function SideBar() {
 ...
 const ListboxWrapper = ({children}) => (
  <div className=" w-full max-w-[200px] border-small px-1 py-2 rounded-small border-default-200 dark:border-default-100 min-h-[100vh] hidden fixed hidden xl:flex">
    {children}
  </div>
);
  return (
