    ...
    <>
      ...
      <div className="container mt-[4rem]">
        ...
        <label className="custom-file-upload">
          <input className="title" type="file"  ref={fileInputRef} onChange={onFileChange} />
       ...
       <Button onPress={onFileUpload} disabled={loading || !selectedFile} className="mt-[2rem] w-[170px] bg-primary text-white">
              Zatwierdź
            </Button>
...
const StyledWrapper = styled.div`
  .container {
    ...
    padding: 10px;
    background: linear-gradient(135deg, oklch(47.655% 0.23035 318.675), oklch(50.655% 0.23035 318.675));
    border-radius: 15px;
